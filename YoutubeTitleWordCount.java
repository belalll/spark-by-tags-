...
public class YoutubeTitleWordCount {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // LOAD DATASETS
        JavaRDD<String> videos = sparkContext.textFile ("F:\\java\\Lect_demo (1)\\SPKTest\\src\\main\\resources\\data\\USvideos.csv");
        
   
        
        // TRANSFORMATIONS
        JavaRDD<String> title = videos
                .map (YoutubeTitleWordCount::extractTitle)
                .filter (StringUtils::isNotBlank);
       // JavaRDD<String>
        JavaRDD<String> words = title.flatMap (tags -> Arrays.asList (tags
                .toLowerCase ()
                .trim ()
                //.replaceAll ("\\p{Punct}", " ")
               .split ("or ")).iterator ());
